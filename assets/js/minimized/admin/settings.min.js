...
/**
 * CTA Manager - Settings Form Handler
 * 
 * Handles settings form AJAX save, validation feedback,
 * and live preview of button changes.
 */
 ...
 *
 * Entry point for the Settings page (cta-manager-settings).
 * Handles global plugin settings, license management, and configuration.
 *
 * When bundled with npm, this file will import:
 * - pages/settings (CTASettings module)
 *
...
(function ($) {
   ...
   */
  window.CTASettingsPage = window.CTASettingsPage || {
    /**
    ...
    onAdminReady: function () {
      // Settings module self-initializes via pages/settings.js

      // Trigger page ready event
      $(document).trigger('ctaSettingsReady', [this]);
    }
  };

  // Initialize on document ready
  $(function () {
    window.CTASettingsPage.init();
  });
})(jQuery);
}();
/******/ })()
