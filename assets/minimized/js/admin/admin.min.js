/*!
 * CTA Manager - Admin Global Bundle
 *
 * Global JavaScript bundle loaded on all CTA Manager admin pages.
 *
 * @package    CTA_Manager
 * @version    1.0.0
...
/***/ "./assets/js/admin/modules/forms/action-type-fields.js":
/*!*************************************************************!*\
  !*** ./assets/js/admin/modules/forms/action-type-fields.js ***!
  \*************************************************************/
...
/**
 * CTA Manager - Action Type Fields Module
 *
 * Handles phone/email/link field group visibility based on
 * the selected CTA type. Applies to both inline dashboard
 * forms and the global form modal.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(function ($) {
  ...
  function initActionTypeFields($form) {
    if (!$form || !$form.length) return;
    var $typeSelect = $form.find('#cta-type');
    if (!$typeSelect.length) return;

    // Skip if the preview modal already handles this form (has a live preview card)
    var $container = $form.closest('#cta-cta-section, .cta-section, .cta-global-form-container, .cta-global-form-modal');
    if ($container.find('#cta-live-preview .cta-preview-card').length) {
      return;
    }
    var $phoneGroup = $form.find('#cta-phone-number-group');
    var $emailGroup = $form.find('#cta-email-to-group');
    var $linkGroup = $form.find('#cta-link-url-group');
    function toggleFields() {
      var type = $typeSelect.val();
      $phoneGroup.hide();
      $emailGroup.hide();
      $linkGroup.hide();
      setRequired($phoneGroup.find('input'), false);
      setRequired($emailGroup.find('input'), false);
      setRequired($linkGroup.find('input[type="url"]'), false);
      switch (type) {
        case 'email':
          $emailGroup.show();
          setRequired($emailGroup.find('input'), true);
          break;
        case 'link':
          $linkGroup.show();
          setRequired($linkGroup.find('input[type="url"]'), true);
          break;
        case 'popup':
        case 'slide-in':
          break;
        default:
          $phoneGroup.show();
          setRequired($phoneGroup.find('input'), true);
          break;
      }
    }
  ...
  $(function () {
    $('.cta-cta-form').each(function () {
      initActionTypeFields($(this));
    });
  });
  $(document).on('ctc:initCtaForm', function (e, form) {
    initActionTypeFields($(form));
  });
})(jQuery);
...
/***/ "./assets/js/admin/modules/forms/button-styling-events.js":
/*!****************************************************************!*\
  !*** ./assets/js/admin/modules/forms/button-styling-events.js ***!
  \****************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   bindEventHandlers: function() { return /* binding */ bindEventHandlers; }
/* harmony export */ });
/**
 * CTA Manager - Button Styling Events Module
 *
 * Delegated event handlers for padding, border width,
...
/**
 * Bind all delegated event handlers — called once on page load
 */
function bindEventHandlers() {
  ...
  $(document).on('input', '#cta-gradient-angle', function () {
    ...
    const $form = $(this).closest('form');
    $form.find('.cta-angle-value').text(value + '\u00B0');
    updateGradientPreview($form);
    $(this).trigger('change');
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _button_styling_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./button-styling-events */ "./assets/js/admin/modules/forms/button-styling-events.js");
/**
 * CTA Manager - Button Styling Form Module
 *
 * Contains JavaScript behavior for the button styling form UI.
...
(function ($) {
  ...
  $(function () {
    (0,_button_styling_events__WEBPACK_IMPORTED_MODULE_0__.bindEventHandlers)();
...
/***/ "./assets/js/admin/modules/forms/dashboard-form-handlers.js":
/*!******************************************************************!*\
  !*** ./assets/js/admin/modules/forms/dashboard-form-handlers.js ***!
  \******************************************************************/
/***/ (function() {
...
/**
 * CTA Manager - Dashboard Form Handlers Module
 *
 * CTA form field change handlers, icon management, and Pro validation.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(function ($) {
   ...
   * Uses event delegation to work with dynamically loaded modal forms
   */
  CTCAdmin.handleLayoutChange = function () {
    function deriveUiFromStoredLayout(storedLayout) {
      if (storedLayout === 'card-left' || storedLayout === 'card-right' || storedLayout === 'card-top' || storedLayout === 'card-bottom') {
        return {
          layout: 'card',
      ...
      return {
        layout: 'button',
        cardLayout: 'card-left'
      };
    }
    function getStoredLayoutFromUi($scope) {
      var layoutUi = $scope.find('#cta-layout').val() || 'button';
      var cardLayout = $scope.find('#cta-card-layout').val() || 'card-left';
      return layoutUi === 'card' ? cardLayout : 'button';
    }
    function syncLayoutUiFromStored($scope) {
      var $layoutSelect = $scope.find('#cta-layout');
      var $cardLayoutSelect = $scope.find('#cta-card-layout');
      var $layoutValue = $scope.find('#cta-layout-value');
      if (!$layoutSelect.length || !$cardLayoutSelect.length || !$layoutValue.length) {
        return;
      }
      var derived = deriveUiFromStoredLayout($layoutValue.val() || 'button');
      $layoutSelect.val(derived.layout);
      $cardLayoutSelect.val(derived.cardLayout);
    }
    function applyLayoutUiState($scope) {
      var $layoutSelect = $scope.find('#cta-layout');
      var $cardLayoutGroup = $scope.find('#cta-card-layout-group');
      var $layoutValue = $scope.find('#cta-layout-value');
      var selectedValue = $layoutSelect.val() || 'button';
      var isPro = $layoutSelect.data('is-pro') === 1;
      var requiresPro = $layoutSelect.find('option:selected').data('requires-pro') === 1;
      var $titleGroup = $scope.find('#cta-title-group');
      var $cardTextRow = $scope.find('#cta-card-text-row');
      var $cardProBadges = $scope.find('#cta-title-group .cta-pro-badge, #cta-tagline-group .cta-pro-badge, #cta-body-text-group .cta-pro-badge');
      if ($cardLayoutGroup.length) {
        $cardLayoutGroup.toggle(selectedValue === 'card');
      }
      if ($layoutValue.length) {
        var nextLayoutValue = getStoredLayoutFromUi($scope);
        if ($layoutValue.val() !== nextLayoutValue) {
          $layoutValue.val(nextLayoutValue).trigger('change');
        }
      }
      if ($titleGroup.length) {
        $titleGroup.toggle(selectedValue !== 'button');
      }
      if ($cardTextRow.length) {
        $cardTextRow.toggle(selectedValue !== 'button');
      }
      if (selectedValue === 'button') {
        $cardProBadges.hide();
        $('#cta-title, #cta-tagline, #cta-body-text, #cta_body_text_editor').prop('disabled', false);
        $('.cta-format-icon-btn').prop('disabled', false);
      } else if (requiresPro && !isPro) {
        $cardProBadges.show();
        $('#cta-title, #cta-tagline, #cta-body-text, #cta_body_text_editor').prop('disabled', true);
    ...
    // Use delegation so it works for forms cloned from <template>
    $(document).on('change', '#cta-layout, #cta-card-layout', function () {
      var $scope = $(this).closest('.cta-section, .cta-global-form-container, .cta-global-form-modal, form');
      if (!$scope.length) {
        $scope = $(document);
      }
      applyLayoutUiState($scope);
    });

    // Gray out Pro options when select exists
    var $layoutSelect = $('#cta-layout');
    var $layoutValueField = $('#cta-layout-value');
    if ($layoutSelect.length) {
      var isPro = $layoutSelect.data('is-pro') === 1;
      if (!isPro) {
        $layoutSelect.find('option[data-requires-pro="1"]').css({
          'color': '#999',
          'font-style': 'italic'
        });
      }
      var $rootScope = $layoutSelect.closest('.cta-section, .cta-global-form-container, .cta-global-form-modal, form');
      if ($rootScope.length) {
        syncLayoutUiFromStored($rootScope);
        applyLayoutUiState($rootScope);
      } else {
        $layoutSelect.trigger('change');
      }
    }

    // Re-initialize when form is loaded in modal
    $(document).on('ctc:initCtaForm', function (e, form) {
      var $form = $(form);
      var $modalLayoutSelect = $form.find('#cta-layout');
      if ($modalLayoutSelect.length) {
        var isPro = $modalLayoutSelect.data('is-pro') === 1;
        if (!isPro) {
          $modalLayoutSelect.find('option[data-requires-pro="1"]').css({
            'color': '#999',
            'font-style': 'italic'
          });
        }
        syncLayoutUiFromStored($form);
        applyLayoutUiState($form);
      }
    });
    $(document).on('ctc:editFormPopulated', function (e, $form) {
      if (!$form || !$form.length) {
        return;
      }
      syncLayoutUiFromStored($form);
  ...
  CTCAdmin.checkCtaProOnSubmit = function () {
    ...
    var isPro = $layoutSelect.data('is-pro') === 1;
    var layoutUi = $layoutSelect.val() || 'button';
    var layoutRequiresPro = layoutUi === 'card';
  ...
  $(function () {
    // Must always register layout listeners (global modal form can be injected later).
    ...
    if ($('#cta-cta-form').length) {
      ...
      $('#cta-cta-form').on('submit', function (e) {
        ...
        var $layoutValueField = $('#cta-layout-value');
        var isPro = $layoutSelect.data('is-pro') === 1;
        if ($layoutValueField.length) {
          $layoutValueField.val(($layoutSelect.val() || 'button') === 'card' ? $('#cta-card-layout').val() || 'card-left' : 'button');
        }
        if (!isPro) {
          $('#cta-title').val('');
          $('#cta-tagline').val('');
          $('#cta-body-text, #cta_body_text_editor').val('');
...
/***/ "./assets/js/admin/modules/modals/dashboard-preview.js":
/*!*************************************************************!*\
  !*** ./assets/js/admin/modules/modals/dashboard-preview.js ***!
  \*************************************************************/
/***/ (function() {
...
/**
 * CTA Manager - Dashboard Preview Module
 *
 * Preview rendering, button styling, format modal, and live preview updates.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
(function ($) {
  ...
  CTCAdmin.generateFrontendPreview = function (cta) {
    ...
    if (layout === 'card') {
      layout = cta.card_layout || 'card-left';
    }
    ...
    var hasValidIcon = iconChoice && iconChoice !== 'none' && this.iconMap && this.iconMap[iconChoice];
    var showIcon = hasValidIcon && cta.show_icon !== false;

    // Build icon HTML using SVG icons from CTCAdmin.iconMap
    var iconAnimation = cta.icon_animation || 'none';
    var iconAnimClass = iconAnimation && iconAnimation !== 'none' ? ' cta-icon-animation-' + iconAnimation : '';
    var iconHTML = '';
    if (showIcon) {
      iconHTML = '<span class="cta-button__icon' + iconAnimClass + '">' + this.iconMap[iconChoice] + '</span>';
    }
    ...
    var buttonAnimation = cta.button_animation || 'none';
    var buttonAnimClass = buttonAnimation && buttonAnimation !== 'none' ? ' cta-animation-' + buttonAnimation : '';
    var buttonText = cta.button_text || '';
    var buttonHTML = '<a href="#" class="cta-button' + buttonAnimClass + '" style="' + buttonStyles + '" onclick="return false;">' + iconHTML + '<span class="cta-button__text" style="' + textStyles + '">' + this.escapeHtml(buttonText) + '</span>' + '</a>';
  ...
  function getFieldValue(selectors, fallback) {
    var i;
  ...
  function resolveLayoutValue() {
    var layoutUi = $('#cta-layout').val() || 'button';
    var cardLayout = $('#cta-card-layout').val() || 'card-left';
    var storedLayout = $('#cta-layout-value').val() || '';
    if (layoutUi === 'card') {
      return cardLayout;
    }
    return storedLayout || 'button';
  }
  function getBodyTextValue() {
    ...
    return $('#cta_body_text_editor').val() || $('#cta-body-text').val() || '';
  }
  function hasRequiredPreviewFields(ctaType) {
    var name = ($('#cta-name').val() || '').trim();
    ...
    switch (ctaType) {
      case 'email':
        return !!($('#cta-email-to').val() || '').trim();
      case 'link':
        return !!($('#cta-link-url').val() || '').trim();
      case 'popup':
      case 'slide-in':
        return true;
      default:
        return !!($('#phone-number').val() || '').trim();
    }
  }
  ...
  CTCAdmin.updateLivePreview = function () {
    ...
    // Get form values
    var layout = resolveLayoutValue();
    var ctaType = $('#cta-type').val() || 'phone';
    var title = $('#cta-title').val() || '';
    var tagline = $('#cta-tagline').val() || '';
    var bodyText = getBodyTextValue();
    var buttonText = $('#button-text').val() || 'Call Now';
    var iconValue = $('#cta-icon').val() || 'none';
    var buttonAnimation = $('#button-animation').val() || 'none';
    var allRequiredFilled = hasRequiredPreviewFields(ctaType);
    var $previewContainer = $card.closest('.cta-live-preview');
    if (!allRequiredFilled) {
      $card.hide().addClass('is-placeholder');
      $previewContainer.addClass('has-placeholder');
      var $placeholder = $previewContainer.find('.cta-preview-placeholder');
      if (!$placeholder.length) {
        $placeholder = $('<div class="cta-preview-placeholder"></div>');
        $previewContainer.append($placeholder);
      }
      $placeholder.html('<span class="dashicons dashicons-visibility"></span>' + '<span class="cta-preview-placeholder-title">Preview will appear here</span>' + '<span class="cta-preview-placeholder-hint">Complete required General, Display, and Action fields</span>').show();
      return;
    }
    $card.show().removeClass('is-placeholder');
    ...
    $titleEl.css({
      'font-size': getFieldValue(['#cta_title_font_size', '#title_font_size'], '18px'),
      'font-family': getFieldValue(['#cta_title_font_family', '#title_font_family'], 'inherit'),
      'font-weight': getFieldValue(['#cta_title_font_weight', '#title_font_weight'], '700'),
      'color': getFieldValue(['#cta_title_color', '#title_color'], '#1e293b'),
      'text-align': getFieldValue(['#cta_title_alignment', '#title_alignment'], layout === 'card-right' ? 'right' : 'left')
    });

    // Update tagline formatting
    $taglineEl.css({
      'font-size': getFieldValue(['#cta_tagline_font_size', '#tagline_font_size'], '13px'),
      'font-family': getFieldValue(['#cta_tagline_font_family', '#tagline_font_family'], 'inherit'),
      'font-weight': getFieldValue(['#cta_tagline_font_weight', '#tagline_font_weight'], '400'),
      'color': getFieldValue(['#cta_tagline_color', '#tagline_color'], '#64748b'),
      'text-align': getFieldValue(['#cta_tagline_alignment', '#tagline_alignment'], layout === 'card-right' ? 'right' : 'left')
    });

    // Update body formatting
    $bodyEl.css({
      'font-size': getFieldValue(['#cta_body_font_size', '#body_font_size'], '13px'),
      'font-family': getFieldValue(['#cta_body_font_family', '#body_font_family'], 'inherit'),
      'font-weight': getFieldValue(['#cta_body_font_weight', '#body_font_weight'], '400'),
      'color': getFieldValue(['#cta_body_color', '#body_color'], '#475569'),
      'text-align': getFieldValue(['#cta_body_alignment', '#body_alignment'], layout === 'card-right' ? 'right' : 'left')
    });

    // Update button text formatting
    var $buttonLabel = $preview.find('.cta-preview-label');
    var btnAlignment = $('#button_alignment').val() || 'center';
    var alignmentMap = {
      'left': 'flex-start',
      'center': 'center',
      'right': 'flex-end'
    ...
    if (buttonAnimation && buttonAnimation !== 'none') {
      $button.addClass('cta-animation-' + buttonAnimation);
    }

    // Update icon animation class
    var iconAnimation = $('#icon-animation').val() || 'none';
    $iconWrapper.removeClass(function (i, cls) {
      return (cls.match(/(^|\s)cta-icon-animation-\S+/g) || []).join(' ');
    });
    if (iconAnimation && iconAnimation !== 'none') {
      $iconWrapper.addClass('cta-icon-animation-' + iconAnimation);
    }
  };
  ...
  CTCAdmin.bindPreviewUpdates = function () {
    ...
    var textFields = '#cta-name, #cta-title, #cta-tagline, #cta-body-text, #cta_body_text_editor, #button-text, #cta-layout, #cta-layout-value, #cta-card-layout, #cta-type, #cta-icon, #button-animation, #icon-animation, #phone-number, #cta-email-to, #cta-link-url, #cta-link-target-new-tab';
    var formatFields = '#cta_title_font_size, #cta_title_font_family, #cta_title_font_weight, #cta_title_color, #cta_title_alignment, ' + '#title_font_size, #title_font_family, #title_font_weight, #title_color, #title_alignment, ' + '#cta_tagline_font_size, #cta_tagline_font_family, #cta_tagline_font_weight, #cta_tagline_color, #cta_tagline_alignment, ' + '#tagline_font_size, #tagline_font_family, #tagline_font_weight, #tagline_color, #tagline_alignment, ' + '#cta_body_font_size, #cta_body_font_family, #cta_body_font_weight, #cta_body_color, #cta_body_alignment, ' + '#body_font_size, #body_font_family, #body_font_weight, #body_color, #body_alignment, ' + '#button_text_font_size, #button_text_font_family, #button_text_font_weight, #button_text_color, #button_text_alignment';
...
(function ($) {
  ...
  var CTADocsModal = {
    ...
    selectors: {
      ...
      planFilterBtn: '[data-docs-plan-filter]',
      soonToggle: '[data-docs-soon-toggle]',
      sidebarToggle: '[data-docs-sidebar-toggle]',
      layout: '.cta-docs-layout'
    },
    /**
     * State
     */
    ...
    init: function () {
      this.$collapsedSearch = $('<button type="button" class="cta-docs-collapsed-search" aria-label="Search documentation"><span class="dashicons dashicons-search"></span></button>');
      this.bindEvents();
    },
    /**
    ...
    bindEvents: function () {
      ...
      $(document).on('click', '[data-open-modal="#cta-docs-modal"]', function (e) {
        e.preventDefault();
        e.stopImmediatePropagation();
        ...
        var $sidebarLink = $(self.selectors.modal + ' ' + self.selectors.submenuLink + '[data-docs-page="' + targetPage + '"]').first();
        var $welcomeLink = $(self.selectors.modal + ' ' + self.selectors.pageLink + '[data-docs-page="welcome"]').first();
        self.setActiveLink($sidebarLink.length ? $sidebarLink : $welcomeLink);
        if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
          window.ctaModalAPI.open(self.selectors.modal, {
            trigger: this
          });
        } else {
          $(self.selectors.modal).fadeIn(150);
          $('body').addClass('cta-modal-open');
        }
      });
      ...
      $(document).on('click', self.selectors.modal + ' ' + self.selectors.planFilterBtn, function (e) {
        e.preventDefault();
        self.activePlan = $(this).data('docs-plan-filter');
      ...
      $(document).on('click', self.selectors.modal + ' .cta-docs-collapsed-search', function (e) {
        e.preventDefault();
    ...
    resetModal: function () {
      ...
      $modal.find('[data-docs-plan-filter="all"]').addClass('is-active');
    ...
    applyDocFilters: function () {
      ...
      // Hide submenu accordions where all plan-children are filtered
      $modal.find(self.selectors.submenuAccordion).each(function () {
        var $acc = $(this);
        if ($acc.hasClass('is-plan-filtered')) return;
        var $children = $acc.find('[data-docs-plan]');
        if ($children.length && $children.filter(':not(.is-plan-filtered)').length === 0) {
          $acc.addClass('is-plan-filtered');
        }
      });
      ...
      $modal.find(self.selectors.accordionItem).each(function () {
        ...
        if ($item.find('.cta-docs-welcome-link').length) return;
    ...
    showPage: function (pageId) {
      ...
      // Move collapsed-search button into sticky title wrapper when present.
      // Fallback pages (like welcome) use a floating top-right placement.
      var $wrapper = $targetPage.find('.cta-docs-section-title-wrapper').first();
      if ($wrapper.length && this.$collapsedSearch) {
        this.$collapsedSearch.removeClass('is-floating');
        this.$collapsedSearch.appendTo($wrapper);
      } else if (this.$collapsedSearch) {
        this.$collapsedSearch.addClass('is-floating');
        this.$collapsedSearch.prependTo($(this.selectors.content));
      }
    ...
    openDocumentationModalWithFeature: function (featureTitle, categoryType) {
      ...
      // Determine target page and link
      var pageId = 'welcome';
      var $link = $('[data-docs-page="welcome"]');
      if ($targetLink && $targetLink.length) {
        var foundPage = $targetLink.data('docs-page');
        if (foundPage) {
          pageId = foundPage;
          $link = $targetLink;
        }
      ...
      // Reset state and set target page BEFORE showing modal (prevents flash)
      $(this.selectors.searchInput).val('');
      this.handleSearch('');
      this.collapseAllAccordions();
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Features Modal Module
 *
...
(function ($) {
  ...
  var CTAFeaturesModal = {
    ...
    selectors: {
      ...
      layout: '.cta-sidebar-modal-layout',
      sidebarToggle: '[data-features-sidebar-toggle]',
      stickyHeader: '[data-features-sticky-header]',
      stickyTitle: '[data-sticky-title]',
      stickyDescription: '[data-sticky-description]',
      stickyIcon: '[data-sticky-icon]',
      stickyBadge: '[data-sticky-badge]',
      pageContainer: '[data-features-content]',
      pages: '[data-features-page-content]',
      menuLinks: '[data-features-page]',
      pageNav: '[data-page-nav]',
      navButtons: '[data-nav-direction]',
      sidebarSearch: '[data-features-search]'
    },
    /**
     ...
     */
    init: function () {
      this.$collapsedSearch = $('<button type="button" class="cta-features-collapsed-search" aria-label="Search features"><span class="dashicons dashicons-search"></span></button>');
      this.bindEvents();
    },
    /**
     * Bind all event handlers
    ...
    bindEvents: function () {
      ...
      $(document).on('click', self.selectors.modal + ' .cta-features-collapsed-search', function (e) {
        e.preventDefault();
        $(self.selectors.modal).find(self.selectors.layout).removeClass('is-sidebar-collapsed');
        sessionStorage.setItem('cta_features_sidebar_collapsed', '0');
        setTimeout(function () {
    ...
    toggleSidebar: function () {
      ...
      sessionStorage.setItem('cta_features_sidebar_collapsed', isCollapsed ? '1' : '0');
    },
    /**
     * Handle page change
     */
    onPageChange: function ($button) {
      var pageId = $button.data('features-page');
      var $page = $('[data-features-page-content="' + pageId + '"]');
      if (!$page.length) {
        return;
      }
    ...
    updateStickyHeader: function () {
      var $activeMenu = $(this.selectors.menuLinks + '.is-active').first();
      var activePageId = $activeMenu.data('features-page');
      var $activePage = activePageId ? $(this.selectors.modal + ' ' + this.selectors.pages + '[data-features-page-content="' + activePageId + '"]') : $(this.selectors.pages + '.is-active').first();
      var pageHeaderTitle = $activePage.find('.cta-sidebar-modal-page-header h3').first().text().trim();
      var pageHeaderDescription = $activePage.find('.cta-sidebar-modal-page-header p').first().text().trim();
      var title = pageHeaderTitle || this.getMenuLabel($activeMenu) || 'Features';
      if (activePageId === 'overview') {
        title = 'Overview';
      }
      var description = pageHeaderDescription || '';
      var iconClass = $activeMenu.find('.dashicons').first().attr('class') || '';
      var iconMatch = iconClass.match(/dashicons-([a-z0-9-]+)/);
      var icon = iconMatch ? iconMatch[1] : '';
      var $menuLogo = $activeMenu.find('.cta-sidebar-modal-menu-logo').first();
      var $stickyIcon = $(this.selectors.stickyIcon);

      // Update sticky header text
      $(this.selectors.stickyTitle).text(title);

      // Use the overview logo when present, otherwise fall back to the category emoji map.
      if ($menuLogo.length) {
        $stickyIcon.empty().removeClass('has-emoji').addClass('has-logo').append($menuLogo.clone().removeClass('cta-sidebar-modal-menu-logo').addClass('cta-sidebar-modal-sticky-logo'));
      } else if (icon) {
        $stickyIcon.removeClass('has-logo').addClass('has-emoji').text(this.getCategoryIcon(icon));
      } else {
        $stickyIcon.removeClass('has-logo has-emoji').text('');
      }

      // Show/hide badge with actual label (e.g. PRO) when present on active menu item.
      var $badge = $(this.selectors.stickyBadge);
      var badgeText = $activeMenu.find('.cta-sidebar-modal-pro-badge').first().text().trim();
      if (badgeText) {
    ...
    updatePageNavigation: function () {
      ...
      $prevBtn.find('[data-prev-label]').text(prevLabel ? 'Prev: ' + prevLabel : 'Prev');
      $nextBtn.find('[data-next-label]').text(nextLabel ? 'Next: ' + nextLabel : 'Next');
    ...
    getMenuLabel: function ($menuLink) {
      ...
      $clone.find('.dashicons, .cta-sidebar-modal-pro-badge, .cta-sidebar-modal-menu-count').remove();
    ...
    placeCollapsedSearch: function () {
      ...
      var $headerRight = $(this.selectors.modal).find('.cta-sidebar-modal-sticky-header-right');
    ...
    restoreSidebarState: function () {
      var isCollapsed = sessionStorage.getItem('cta_features_sidebar_collapsed') === '1';
      var $layout = $(this.selectors.layout);
      if (isCollapsed) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _partials_global_modal_form__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../partials/global-modal-form */ "./assets/js/admin/modules/partials/global-modal-form.js");
/**
 * CTA Manager - Global Modal Module
 *
 * Contains JavaScript behavior for the global modal.
 * Used by admin entry bundles to handle modal interactions.
 *
 * @package CTA_Manager
 * @since 1.0.0
...
(function ($) {
  ...
  /**
   * Validate a phone number has a recognizable format
   */
  ...
  /**
   * Validate a URL has http(s):// prefix and proper domain format
   */
  function isValidUrl(str) {
    ...
    try {
      var url = new URL(str);
      return /^https?:$/.test(url.protocol) && url.hostname.indexOf('.') !== -1;
    } catch (e) {
      return false;
    }
  }
  ...
  function bindValidationEvents($modal) {
    ...
    $container.off('blur.ctaPhoneValidation', '#phone-number');
    $container.on('blur.ctaPhoneValidation', '#phone-number', function () {
      var $field = $(this);
      var val = $field.val();
    ...
    $container.off('input.ctaPhoneClear', '#phone-number');
    $container.on('input.ctaPhoneClear', '#phone-number', function () {
      var $field = $(this);
      $field.removeClass('cta-field-error');
    ...
    $container.off('blur.ctaUrlValidation', '#cta-link-url');
    $container.on('blur.ctaUrlValidation', '#cta-link-url', function () {
      var $field = $(this);
      var val = $field.val();
      var $error = $field.next('.cta-field-error-message');
      if (val && !isValidUrl(val)) {
        ...
        $error.text('Please enter a valid URL with http:// or https://').show();
      } else {
        $field.removeClass('cta-field-error');
        if ($error.length) {
          $error.hide();
    ...
    $container.off('input.ctaUrlClear', '#cta-link-url');
    $container.on('input.ctaUrlClear', '#cta-link-url', function () {
      var $field = $(this);
      $field.removeClass('cta-field-error');
      $field.next('.cta-field-error-message').hide();
    });
  ...
  function renderTemplate() {
    ...
    if ($form.length) {
      ...
      // Show/hide edit-only status options (Archive, Trash)
      $form.find('.cta-status-edit-only').prop('hidden', !isEditMode);
      if (isEditMode) {
        (0,_partials_global_modal_form__WEBPACK_IMPORTED_MODULE_0__.populateFormWithData)($form, currentCtaData, fieldNameMap);
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Modals Modal Module
 *
 * Contains JavaScript behavior for the modals modal.
 * Used by admin entry bundles to handle modal interactions.
 *
 * @package CTA_Manager
 * @since 1.0.0
...
(function ($) {
  ...
  function closeModal($modal) {
    $modal.fadeOut(150, function () {
      ...
      $modal.find('.cta-modal-overlay').css('visibility', '');
  ...
  function getVisibleModalsInOrder() {
    return $('.cta-modal:visible').get().sort((a, b) => {
  ...
  function syncModalLayering() {
    const ordered = getVisibleModalsInOrder();
    if (!ordered.length) {
      $('body').removeClass('cta-modal-open');
      return;
    }
    ordered.forEach((modalEl, idx) => {
      ...
      $modal.find('.cta-modal-overlay').css('visibility', isTop ? 'visible' : 'hidden');
    });
    $('body').addClass('cta-modal-open');
  }
  $(function () {
    ...
    $(document).on('keydown', function (e) {
      if (e.key === 'Escape') {
        var $visible = $('.cta-modal:visible');
        if (!$visible.length) return;
        // Close only the topmost modal (highest z-index)
...
/***/ "./assets/js/admin/modules/modals/onboarding-modal-import.js":
/*!*******************************************************************!*\
  !*** ./assets/js/admin/modules/modals/onboarding-modal-import.js ***!
  \*******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   bindDemoEvents: function() { return /* binding */ bindDemoEvents; },
/* harmony export */   bindImportEvents: function() { return /* binding */ bindImportEvents; },
/* harmony export */   formatFileSize: function() { return /* binding */ formatFileSize; },
/* harmony export */   handleDemoImportSuccess: function() { return /* binding */ handleDemoImportSuccess; },
/* harmony export */   importDemoData: function() { return /* binding */ importDemoData; },
/* harmony export */   importFile: function() { return /* binding */ importFile; },
/* harmony export */   sendImportData: function() { return /* binding */ sendImportData; }
/* harmony export */ });
/**
 * CTA Manager - Onboarding Modal Import Module
 *
 * File import (Step 2) and demo data import (Step 3)
 * logic for the onboarding wizard.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
 ...
 */
function bindImportEvents(wizard) {
  var $fileInput = wizard.$modal.find('#cta-onboarding-import-file');
  var $wrapper = wizard.$modal.find('#cta-onboarding-file-wrapper');
  var $selected = wizard.$modal.find('#cta-onboarding-file-selected');
  var $fileName = wizard.$modal.find('#cta-onboarding-file-name');
  var $fileSize = wizard.$modal.find('#cta-onboarding-file-size');
  var $removeBtn = wizard.$modal.find('#cta-onboarding-file-remove');
  var $importActions = wizard.$modal.find('#cta-onboarding-import-actions');
  var $importBtn = wizard.$modal.find('#cta-onboarding-import-btn');
  var $status = wizard.$modal.find('#cta-onboarding-import-status');
  $fileInput.on('change', function () {
    var file = this.files[0];
    if (file) {
      wizard.selectedFile = file;
  ...
  var $dropArea = wizard.$modal.find('#cta-onboarding-import-area');
 ...
 */
function bindDemoEvents(wizard) {
  var $demoBtn = wizard.$modal.find('#cta-onboarding-demo-btn');
  var $status = wizard.$modal.find('#cta-onboarding-demo-status');
  $demoBtn.on('click', function () {
    importDemoData(wizard, $demoBtn, $status);
  });
  $(document).on('ctaDemoDataImported', function (e, data) {
    handleDemoImportSuccess(wizard, data);
  });
}

/**
 * Handle successful demo data import
 */
function handleDemoImportSuccess(wizard, data) {
  wizard.step3DemoDataExists = true;
  wizard.updateButtonVisibility();
  wizard.$modal.find('.cta-onboarding-demo-options').fadeOut(300, function () {
...
/**
 * Import demo data using bundled demo-data.json
 */
function importDemoData(wizard, $btn, $status) {
...
function importFile(wizard) {
  ...
  reader.readAsText(wizard.selectedFile);
}

/**
 * Send import data to server
 */
function sendImportData(wizard, data) {
  var $status = wizard.$modal.find('#cta-onboarding-import-status');
  var $importBtn = wizard.$modal.find('#cta-onboarding-import-btn');
  if (typeof ctaAdminVars === 'undefined' || !ctaAdminVars.ajaxUrl) {
    $status.removeClass('status-loading').addClass('status-error');
  ...
  var importSettings = wizard.$modal.find('#onboarding-import-toggle-settings').is(':checked') ? 1 : 0;
  var importCtas = wizard.$modal.find('#onboarding-import-toggle-ctas').is(':checked') ? 1 : 0;
  var importAnalytics = wizard.$modal.find('#onboarding-import-toggle-analytics').is(':checked') ? 1 : 0;
  var importNotifications = wizard.$modal.find('#onboarding-import-toggle-notifications').is(':checked') ? 1 : 0;
  $.ajax({
    url: ctaAdminVars.ajaxUrl,
    type: 'POST',
    data: {
    ...
    success: function (response) {
      if (response.success) {
        ...
        wizard.step2ImportComplete = true;
        wizard.updateButtonVisibility();
        setTimeout(function () {
          wizard.goToStep(3);
        }, 1500);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _onboarding_modal_import__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./onboarding-modal-import */ "./assets/js/admin/modules/modals/onboarding-modal-import.js");
/**
 * CTA Manager - Onboarding Modal Module
 *
 * Contains JavaScript behavior for the onboarding modal.
 * Used by admin entry bundles to handle modal interactions.
 *
 * @package CTA_Manager
 * @since 1.0.0
...
(function ($) {
  ...
  window.CTAOnboarding = {
    ...
    init: function () {
      ...
      this.bindEvents();
      (0,_onboarding_modal_import__WEBPACK_IMPORTED_MODULE_0__.bindImportEvents)(this);
      (0,_onboarding_modal_import__WEBPACK_IMPORTED_MODULE_0__.bindDemoEvents)(this);
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Pro Upsell Modal Module
 *
 * Contains JavaScript behavior for the pro upsell modal.
 * Used by admin entry bundles to handle modal interactions.
 *
 * @package CTA_Manager
 * @since 1.0.0
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _partials_dashboard_utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../partials/dashboard-utils */ "./assets/js/admin/modules/partials/dashboard-utils.js");
/* harmony import */ var _partials_dashboard_utils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_partials_dashboard_utils__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _partials_dashboard_performance__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../partials/dashboard-performance */ "./assets/js/admin/modules/partials/dashboard-performance.js");
/* harmony import */ var _partials_dashboard_performance__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_partials_dashboard_performance__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _modals_dashboard_preview__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../modals/dashboard-preview */ "./assets/js/admin/modules/modals/dashboard-preview.js");
/* harmony import */ var _modals_dashboard_preview__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modals_dashboard_preview__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _forms_dashboard_form_handlers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../forms/dashboard-form-handlers */ "./assets/js/admin/modules/forms/dashboard-form-handlers.js");
/* harmony import */ var _forms_dashboard_form_handlers__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_forms_dashboard_form_handlers__WEBPACK_IMPORTED_MODULE_3__);
/**
 * CTA Manager - Dashboard Page Module (Orchestrator)
 *
 * Core initialization, event binding, and UI setup for the CTA admin.
...
// Side-effect imports: each module attaches methods to window.CTCAdmin
...
(function ($) {
  ...
  CTCAdmin.init = function () {
    // This bundle can be loaded outside CTA screens; no-op in that case.
    if (!$('.cta-admin-container, #cta-cta-form, form.cta-form').length) {
      return;
    }
    if (typeof ctaAdminVars === 'undefined') {
      console.warn('CTC Admin: Missing localization variables on CTA admin screen');
      return;
    }
    this.cacheSelectors();
    this.bindEvents();
  ...
  CTCAdmin.bindEvents = function () {
    ...
    // Pro teaser: open features modal to a specific page (e.g. Analytics)
    this.$document.on('click', '[data-open-features-page]', function (e) {
      e.preventDefault();
      var targetPage = $(this).data('open-features-page');
      var $featuresModal = $('#cta-features-modal');
      if (!$featuresModal.length) return;

      // Open the modal
      if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
        window.ctaModalAPI.open($featuresModal);
      } else {
        $featuresModal.fadeIn(150);
        $('body').addClass('cta-modal-open');
      }

      // Navigate to the target sidebar page
      if (targetPage) {
        var $layout = $featuresModal.find('.cta-sidebar-modal-layout');
        if ($layout.length) {
          $layout.find('[data-features-page]').removeClass('is-active');
          $layout.find('[data-features-page="' + targetPage + '"]').addClass('is-active');
          $layout.find('[data-features-page-content]').removeClass('is-active');
          $layout.find('[data-features-page-content="' + targetPage + '"]').addClass('is-active');
        }
      }
    });
  };
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Support Page Module
 *
 * Contains JavaScript behavior for the support admin page.
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Accordion Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
/***/ "./assets/js/admin/modules/partials/admin-bar-responsive.js":
/*!******************************************************************!*\
  !*** ./assets/js/admin/modules/partials/admin-bar-responsive.js ***!
  \******************************************************************/
/***/ (function() {
...
// Active CTAs click-to-toggle handler
(function () {
  'use strict';

  function init() {
    var menuItem = document.getElementById('wp-admin-bar-cta-manager-active-ctas');
    if (!menuItem) return;
    var label = menuItem.querySelector('.ab-item');
    if (!label) return;

    // Bind directly to the label in capture phase to beat WP's handlers
    label.addEventListener('click', function (e) {
      e.preventDefault();
      e.stopImmediatePropagation();
      menuItem.classList.toggle('cta-ab-active-open');
    }, true);

    // Close when clicking outside
    document.addEventListener('click', function (e) {
      if (!menuItem.contains(e.target)) {
        menuItem.classList.remove('cta-ab-active-open');
      }
    });
  }
  if (document.readyState === 'loading') {
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Components Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
/***/ "./assets/js/admin/modules/partials/dashboard-performance.js":
/*!*******************************************************************!*\
  !*** ./assets/js/admin/modules/partials/dashboard-performance.js ***!
  \*******************************************************************/
/***/ (function() {
...
/**
 * CTA Manager - Dashboard Performance Table Module
 *
 * CTA performance table with sorting, pagination, and filtering.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
/***/ "./assets/js/admin/modules/partials/dashboard-utils.js":
/*!*************************************************************!*\
  !*** ./assets/js/admin/modules/partials/dashboard-utils.js ***!
  \*************************************************************/
/***/ (function() {
...
/**
 * CTA Manager - Dashboard Utilities Module
 *
 * Form handling, validation, notices, tooltips, clipboard, and shared helpers.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Debug Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
(function (window) {
  ...
  var CTADebug = {
    ...
    success: function (message, context) {
      if (!isDebugEnabled()) return;
      var args = Array.prototype.slice.call(arguments, 2);
      console.log.apply(console, [getPrefix(context), styles.success, '✓ ' + message].concat(args));
    },
    /**
...
/***/ "./assets/js/admin/modules/partials/global-modal-form.js":
/*!***************************************************************!*\
  !*** ./assets/js/admin/modules/partials/global-modal-form.js ***!
  \***************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   humanTimeDiff: function() { return /* binding */ humanTimeDiff; },
/* harmony export */   populateFormWithData: function() { return /* binding */ populateFormWithData; },
/* harmony export */   populateMetadataSection: function() { return /* binding */ populateMetadataSection; }
/* harmony export */ });
/**
 * CTA Manager - Global Modal Form Module
 *
 * Form population, metadata rendering, and
 * time formatting for the global CTA modal.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
function populateMetadataSection($form, ctaData) {
  ...
  var createdByName = ctaData.created_by_name || '\u2014';
 ...
 */
function populateFormWithData($form, ctaData, fieldNameMap) {
  ...
  $.each(ctaData, function (key, value) {
    ...
    // blacklist_urls — populate hidden inputs and update count badge
    if (key === 'blacklist_urls') {
      var $hiddenContainer = $form.find('#cta-blacklist-hidden-container');
      var $countBadge = $form.find('#cta-blacklist-count');
      if ($hiddenContainer.length) {
        $hiddenContainer.empty();
        var urlList = Array.isArray(value) ? value : [];
        urlList.forEach(function (url) {
          $('<input type="hidden" name="cta_blacklist_urls[]" />').val(url).appendTo($hiddenContainer);
        });
        if ($countBadge.length) {
          $countBadge.text(urlList.length);
        }
      }
      return;
    }

    // slide_in_settings — flatten nested object into individual form fields
    if (key === 'slide_in_settings' && typeof value === 'object' && value !== null) {
      var slideFieldMap = {
        trigger_type: 'slide_in_trigger_type',
        trigger_delay: 'slide_in_trigger_delay',
        trigger_scroll: 'slide_in_trigger_scroll',
        position: 'slide_in_position',
        show_animation: 'slide_in_show_animation',
        hide_animation: 'slide_in_hide_animation',
        auto_dismiss: 'slide_in_auto_dismiss',
        auto_dismiss_delay: 'slide_in_auto_dismiss_delay',
        dismiss_behavior: 'slide_in_dismiss_behavior'
      };
      $.each(slideFieldMap, function (dataKey, fieldName) {
        if (value[dataKey] === undefined || value[dataKey] === null) {
          return;
        }
        var fieldVal = value[dataKey];
        var $slideField = $form.find('[name="' + fieldName + '"]');
        if (!$slideField.length) {
          return;
        }
        if ($slideField.is(':checkbox')) {
          $slideField.prop('checked', !!fieldVal).trigger('change');
        } else if ($slideField.is(':radio')) {
          $slideField.filter('[value="' + fieldVal + '"]').prop('checked', true).trigger('change');
        } else {
          $slideField.val(fieldVal).trigger('change');
        }
      });
      return;
    }

    // tracking objects — map bracket-notation fields (gtm_tracking[key], etc.)
    if ((key === 'gtm_tracking' || key === 'ga4_tracking' || key === 'posthog_tracking') && typeof value === 'object' && value !== null) {
      $.each(value, function (subKey, subValue) {
        if (subValue === null || subValue === undefined) {
          return;
        }
        var trackingFieldName = key + '[' + subKey + ']';
        var $trackingField = $form.find('[name="' + trackingFieldName + '"]');
        if (!$trackingField.length) {
          return;
        }
        if ($trackingField.is(':checkbox')) {
          $trackingField.prop('checked', !!subValue).trigger('change');
        } else {
          $trackingField.val(subValue);
        }
      });
      return;
    }
    ...
    if ($field.length) {
      if ($field.is(':checkbox')) {
        ...
        $field.val(value);
        if (fieldName === 'cta_body_text' && window.tinymce && typeof window.tinymce.get === 'function') {
          var bodyEditor = window.tinymce.get('cta_body_text_editor') || window.tinymce.get('cta-body-text');
          if (bodyEditor && !bodyEditor.isHidden()) {
            bodyEditor.setContent(value || '');
          }
        }
      }
    }
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Modal Shell Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
(function ($) {
  ...
  var modalOpenOrder = 0;
  var modalZBase = 999999;
  ...
  function getTopVisibleModal(excludeId) {
    var ordered = getVisibleModalsInOrder();
    for (var idx = ordered.length - 1; idx >= 0; idx -= 1) {
      var modalEl = ordered[idx];
  ...
  function inferSourceModal(options, targetId) {
    if (options && options.sourceModal) {
      var $source = normalizeModalTarget(options.sourceModal);
      if ($source.length) {
        return $source;
      }
    }
    if (options && options.trigger) {
      var triggerEl = options.trigger.jquery ? options.trigger[0] : options.trigger;
      if (triggerEl && triggerEl.closest) {
        var sourceFromTrigger = triggerEl.closest('.cta-modal');
        if (sourceFromTrigger && sourceFromTrigger.id !== targetId) {
          return $(sourceFromTrigger);
        }
      }
    }
    return getTopVisibleModal(targetId);
  }
  ...
  function openModal(modalTarget, options) {
    var $modal = normalizeModalTarget(modalTarget);
    if (!$modal.length) {
      return;
    }
    ...
    resetModalState($modal);
    var modalId = $modal.attr('id') || '';
    var $sourceModal = options && options.inheritState === false ? $() : inferSourceModal(options || {}, modalId);
  ...
  function getVisibleModalsInOrder() {
    return $('.cta-modal:visible').get().sort(function (a, b) {
      var aOrder = parseInt($(a).attr('data-modal-open-order'), 10) || 0;
      var bOrder = parseInt($(b).attr('data-modal-open-order'), 10) || 0;
      return aOrder - bOrder;
    });
  }
  function syncModalLayering() {
    ...
    ordered.forEach(function (modalEl, idx) {
      var isTop = idx === ordered.length - 1;
      var $modal = $(modalEl);
      $modal.css({
        'z-index': modalZBase + idx * 2,
        'pointer-events': isTop ? 'auto' : 'none'
...
/***/ "./assets/js/admin/modules/partials/notifications-rendering.js":
/*!*********************************************************************!*\
  !*** ./assets/js/admin/modules/partials/notifications-rendering.js ***!
  \*********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createLicenseCtaHtml: function() { return /* binding */ createLicenseCtaHtml; },
/* harmony export */   createNotificationElement: function() { return /* binding */ createNotificationElement; },
/* harmony export */   createRegularNotificationHtml: function() { return /* binding */ createRegularNotificationHtml; },
/* harmony export */   escapeHtml: function() { return /* binding */ escapeHtml; }
/* harmony export */ });
/**
 * CTA Manager - Notifications Rendering Module
 *
 * HTML rendering functions for notification items
 * including regular notifications and license CTA cards.
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
function createNotificationElement(notification) {
  ...
  if (isLicenseCta) {
    ...
    li.innerHTML = createLicenseCtaHtml(notification);
  } else {
    li.className = 'cta-notification-item';
    li.innerHTML = createRegularNotificationHtml(notification);
  }
  return li;
}
 ...
 */
function createLicenseCtaHtml(notification) {
  let actionsHtml = '';
  if (notification.actions && notification.actions.length > 0) {
    ...
    notification.actions.forEach(action => {
      let dataAttrs = '';
      if (action.scrollTo) {
        dataAttrs += ' data-scroll-to="' + escapeHtml(action.scrollTo) + '"';
      }
      if (action.focusField) {
        dataAttrs += ' data-focus-field="' + escapeHtml(action.focusField) + '"';
      }
      actionsHtml += '<a href="' + escapeHtml(action.url) + '" class="cta-button cta-pro-upgrade-button cta-pro-upgrade-button--primary cta-button-primary cta-add-api-key-button"' + dataAttrs + '>' + '<span class="dashicons dashicons-unlock"></span>' + '<span class="cta-pro-upgrade-button__label">' + escapeHtml(action.label) + '</span>' + '</a>';
    });
    actionsHtml += '</div>';
  }
  return '<div class="cta-notification-license-glow"></div>' + '<div class="cta-notification-license-header">' + '<div class="cta-notification-license-icon">' + '<span class="dashicons dashicons-star-filled cta-animate-slow"></span>' + '</div>' + '<div class="cta-notification-license-text">' + '<h4 class="cta-notification-license-title">' + escapeHtml(notification.title) + '</h4>' + '<span class="cta-pro-badge"><span class="cta-pro-badge__text">Pro</span></span>' + '</div>' + '</div>' + '<p class="cta-notification-license-message">' + escapeHtml(notification.message) + '</p>' + actionsHtml;
}
...
function createRegularNotificationHtml(notification) {
  ...
  if (notification.actions && notification.actions.length > 0) {
    ...
    notification.actions.forEach(action => {
      ...
      if (action.class) {
        actionClass += ' ' + escapeHtml(action.class);
      }
      let dataAttrs = '';
      if (action.scrollTo) {
        dataAttrs += ' data-scroll-to="' + escapeHtml(action.scrollTo) + '"';
      ...
      actionsHtml += '<a href="' + escapeHtml(action.url) + '" class="' + actionClass + '"' + dataAttrs + '>' + escapeHtml(action.label) + '</a>';
    });
    actionsHtml += '</div>';
  }
  ...
  return '<div class="cta-notification-content">' + '<div class="cta-notification-icon cta-notification-icon--' + escapeHtml(notification.icon) + '">' + '<span class="dashicons dashicons-' + escapeHtml(notification.icon) + '"></span>' + '</div>' + '<div class="cta-notification-text">' + '<h4 class="cta-notification-title">' + escapeHtml(notification.title) + '</h4>' + '<p class="cta-notification-message">' + escapeHtml(notification.message) + '</p>' + actionsHtml + '</div>' + '</div>' + deleteButtonHtml;
}
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _notifications_rendering__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./notifications-rendering */ "./assets/js/admin/modules/partials/notifications-rendering.js");
/**
 * CTA Manager - Notifications Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
const NotificationsManager = {
  ...
  openPanel() {
    ...
    // Write modal param to URL for shareable links
    var url = new URL(window.location.href);
    url.searchParams.set('modal', 'notifications');
  ...
  closePanel() {
    ...
    var url = new URL(window.location.href);
    if (url.searchParams.get('modal') === 'notifications') {
  ...
  renderNotifications(notifications) {
    ...
    notifications.forEach(notification => {
      const item = (0,_notifications_rendering__WEBPACK_IMPORTED_MODULE_0__.createNotificationElement)(notification);
  ...
  /**
   * Escape HTML string (delegate to rendering module)
   */
  escapeHtml(text) {
    return (0,_notifications_rendering__WEBPACK_IMPORTED_MODULE_0__.escapeHtml)(text);
  }
};
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Tabs Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
(function ($) {
  ...
  const CTATabs = {
    ...
    switchTab: function ($btn, target) {
      ...
      // Update tab panels — panels may be inside .cta-tabs or in a sibling .cta-tab-panels
      var $panelScope = $tabs.find('.cta-tab-panel').length ? $tabs : $tabs.siblings('.cta-tab-panels');
      $panelScope.find('.cta-tab-panel').removeClass('is-active');
      const $targetPanel = $panelScope.find('#' + target);
      $targetPanel.addClass('is-active');

      // Store active tab in sessionStorage (skip if data-no-storage attribute is present)
      if ($tabs.attr('data-no-storage') !== 'true' && $tabs.data('no-storage') !== true) {
      ...
      // Scroll to top of tab content (skip if disabled)
      if ($tabs.attr('data-no-scroll') !== 'true' && $tabs.data('no-scroll') !== true) {
    ...
    scrollToTabContent: function ($tabs) {
      // Skip scrolling if tabs container has data-no-scroll attribute
      if ($tabs.attr('data-no-scroll') === 'true' || $tabs.data('no-scroll') === true) {
        return;
      }
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - Toast Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
    ...
    show(message, type = 'info', options = {}) {
      ...
      const $toast = $(`
        <div class="cta-toast cta-toast-${type}${widthClass}" role="alert" aria-live="polite">
          ...
          ${settings.manualDismiss ? '<button type="button" class="cta-toast-close" aria-label="Close notification">×</button>' : ''}
...
/***/ "./assets/js/admin/modules/partials/url-params.js":
/*!********************************************************!*\
  !*** ./assets/js/admin/modules/partials/url-params.js ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/**
 * CTA Manager - URL Params Handler
 *
 * Reads ?modal= and ?tab= URL params on page load to auto-open
 * modals to specific tabs/pages for shareable links. Also writes
 * params to the address bar whenever a modal opens, navigates, or closes.
 *
 * Uses MutationObserver on the style attribute to detect fadeIn/fadeOut
 * visibility changes — works regardless of how the modal was opened.
 *
 * Features modal:  ?modal=features[&tab={category-slug}]
 * Docs modal:      ?modal=docs[&tab={docs-page-id}]
 * Any other modal: ?modal={slug}
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(function ($) {
  ...
  var MODAL_MAP = {
    'features': 'cta-features-modal',
    'docs': 'cta-docs-modal',
    'new-cta': 'cta-global-form-modal',
    'pro-upgrade': 'cta-pro-upgrade-modal',
    'support': 'cta-new-ticket-modal',
    'filters': 'cta-filters-modal',
    'preview': 'cta-preview-modal',
    'onboarding': 'cta-dashboard-help-modal',
    'import-demo': 'cta-import-demo-modal'
  };

  // All URL params this module manages — always cleared together on close
  var ALL_PARAMS = ['modal', 'tab', 'id'];

  // Build tracked selectors string for checking if any modal is still open
  var TRACKED_SELECTORS = Object.keys(MODAL_MAP).map(function (slug) {
    return '#' + MODAL_MAP[slug];
  }).join(', ');
  function getParam(key) {
    return new URLSearchParams(window.location.search).get(key);
  }
  function isCtaPageContext() {
    var page = new URLSearchParams(window.location.search).get('page') || '';
    var bodyClass = document.body ? document.body.className || '' : '';
    if (page === 'cta-manager' || page.indexOf('cta-manager-') === 0) {
      return true;
    }
    return bodyClass.indexOf('toplevel_page_cta-manager') !== -1 || bodyClass.indexOf('cta-manager_page_') !== -1;
  }
  ...
  function openDocsModal(page) {
    var docsModal = window.CTADocsModal;
    if (!docsModal) return;
    docsModal.collapseAllAccordions();
    docsModal.showPage(page);
    var $link = $('#cta-docs-modal [data-docs-page="' + page + '"]').first();
    docsModal.setActiveLink($link.length ? $link : $('[data-docs-page="welcome"]'));
    if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
      window.ctaModalAPI.open('#cta-docs-modal', {
        inheritState: false
      });
    } else {
      $('#cta-docs-modal').fadeIn(150);
      $('body').addClass('cta-modal-open');
    }
  }

  // ─────────────────────────────────────────────────────────────────────────
  // MutationObserver: write URL params when a modal's visibility changes
  //
  // CTA Manager modals use fadeIn/fadeOut (display:none ↔ display:block)
  // instead of class toggling, so we observe the style attribute and check
  // jQuery's :visible to detect actual open/close transitions.
  // ─────────────────────────────────────────────────────────────────────────
  ...
  function watchModal($el, slug, getExtraParams) {
    ...
    var observer = new MutationObserver(function () {
      ...
      // Only act on actual visibility changes
      if (isVisible === wasVisible) return;
      wasVisible = isVisible;
      if (isVisible) {
        // Modal opened — build full param set
        var params = {
          modal: slug
        };
        ALL_PARAMS.forEach(function (k) {
        ...
        // Modal closed — only clear when no other tracked modal remains visible
        if (!$(TRACKED_SELECTORS).filter(':visible').length) {
          cleanAllParams();
        }
      }
    });
  ...
  $(function () {
    ...
    if (modal) {
      ...
      if (modal === 'features') {
        setTimeout(function () {
          if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
            window.ctaModalAPI.open('#' + modalId, {
              inheritState: false
            });
          }
          if (tab) {
            var $btn = $('#cta-features-modal [data-features-page="' + tab + '"]').first();
      ...
      } else if (modal === 'new-cta') {
        setTimeout(function () {
          if (id) {
            // Edit mode — click the edit trigger for this CTA ID
            var $editBtn = $('[data-open-modal="#cta-global-form-modal"][data-cta-id="' + id + '"]').first();
            if ($editBtn.length) {
        ...
        setTimeout(function () {
          var notifBtn = document.querySelector('.cta-notification-button');
          if (notifBtn) {
            notifBtn.click();
          }
        }, 300);
      } else if (modal === 'add-license') {
        window.location.href = 'admin.php?page=cta-manager-settings#cta-pro-license-key';
        return;
      } else {
        // Generic: open any modal by slug or raw ID
        setTimeout(function () {
          if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
            window.ctaModalAPI.open('#' + modalId, {
              inheritState: false
    ...
    // ── Watch all mapped modals via MutationObserver ──────────────────────
    Object.keys(MODAL_MAP).forEach(function (slug) {
      var id = MODAL_MAP[slug];
      var $el = $('#' + id);
      var extraFn = null;
      if (slug === 'new-cta') {
        extraFn = function () {
          var $idField = $('#cta-global-form-modal input[name="cta_id"]');
          var ctaId = $idField.length ? $idField.val() : null;
          return {
            id: ctaId || null
          };
        };
        ...
        extraFn = function () {
          var $active = $('#cta-features-modal [data-features-page].is-active').first();
          return {
            tab: $active.length ? $active.data('features-page') : null
          };
        };
      } else if (slug === 'docs') {
        extraFn = function () {
          var page = window.CTADocsModal ? window.CTADocsModal.currentPage : null;
          return {
            tab: page && page !== 'welcome' ? page : null
          };
        };
      }
      watchModal($el, slug, extraFn);
    });

    // ── Update tab param when features modal page changes ─────────────────
    $(document).on('click', '#cta-features-modal [data-features-page]', function () {
      setParams({
        modal: 'features',
        tab: $(this).data('features-page')
      });
    });

    // ── Update tab param when docs modal page changes ─────────────────────
    $(document).on('click', '#cta-docs-modal [data-docs-page]', function () {
      var page = $(this).data('docs-page');
      if (page) {
        setParams({
          modal: 'docs',
    ...
    $(document).on('click', '#cta-docs-modal .cta-docs-accordion-trigger', function () {
      setTimeout(function () {
        var page = window.CTADocsModal ? window.CTADocsModal.currentPage : null;
        if (page) {
          setParams({
...
/***/ "./assets/js/admin/modules/partials/visitor-tracking.js":
/*!**************************************************************!*\
  !*** ./assets/js/admin/modules/partials/visitor-tracking.js ***!
  \**************************************************************/
/***/ (function() {
...
/**
 * CTA Manager - Visitor Tracking Utility Module
 *
 * Contains shared JavaScript utilities for the admin interface.
 * Used across admin pages to support reusable interactions.
 *
...
(function ($) {
  ...
  window.CTAVisitorTracking = {
    STORAGE_KEY: 'cta_visitor_id',
    ...
    /**
     * Sync visitor ID between cookie and localStorage
     */
    syncVisitorId: function () {
      const cookieId = this.getCookie(this.COOKIE_NAME);
      const storageId = localStorage.getItem(this.STORAGE_KEY);
      if (cookieId && !storageId) {
        localStorage.setItem(this.STORAGE_KEY, cookieId);
      } else if (!cookieId && storageId) {
        this.setCookie(this.COOKIE_NAME, storageId, this.COOKIE_DAYS);
      }
    },
    /**
     * Get cookie value
    ...
    getVisitorId: function () {
      return this.getCookie(this.COOKIE_NAME) || localStorage.getItem(this.STORAGE_KEY);
    }
  };
  $(function () {
    window.CTAVisitorTracking.init();
  });
})(jQuery);
...
/* harmony import */ var _modules_partials_visitor_tracking__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../modules/partials/visitor-tracking */ "./assets/js/admin/modules/partials/visitor-tracking.js");
/* harmony import */ var _modules_partials_visitor_tracking__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_partials_visitor_tracking__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_partials_url_params__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../modules/partials/url-params */ "./assets/js/admin/modules/partials/url-params.js");
/* harmony import */ var _modules_partials_admin_bar_responsive__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../modules/partials/admin-bar-responsive */ "./assets/js/admin/modules/partials/admin-bar-responsive.js");
/* harmony import */ var _modules_partials_admin_bar_responsive__WEBPACK_IMPORTED_MODULE_9___default = /*#__PURE__*/__webpack_require__.n(_modules_partials_admin_bar_responsive__WEBPACK_IMPORTED_MODULE_9__);
/* harmony import */ var _modules_modals_modals__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../modules/modals/modals */ "./assets/js/admin/modules/modals/modals.js");
/* harmony import */ var _modules_modals_global_modal__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../modules/modals/global-modal */ "./assets/js/admin/modules/modals/global-modal.js");
/* harmony import */ var _modules_modals_preview_modal__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../modules/modals/preview-modal */ "./assets/js/admin/modules/modals/preview-modal.js");
/* harmony import */ var _modules_forms_action_type_fields__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../modules/forms/action-type-fields */ "./assets/js/admin/modules/forms/action-type-fields.js");
/* harmony import */ var _modules_modals_docs_modal__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../modules/modals/docs-modal */ "./assets/js/admin/modules/modals/docs-modal.js");
/* harmony import */ var _modules_modals_pro_upsell_modal__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../modules/modals/pro-upsell-modal */ "./assets/js/admin/modules/modals/pro-upsell-modal.js");
/* harmony import */ var _modules_modals_features_modal__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../modules/modals/features-modal */ "./assets/js/admin/modules/modals/features-modal.js");
/* harmony import */ var _modules_modals_onboarding_modal__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../modules/modals/onboarding-modal */ "./assets/js/admin/modules/modals/onboarding-modal.js");
/* harmony import */ var _modules_modals_format_modal__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../modules/modals/format-modal */ "./assets/js/admin/modules/modals/format-modal.js");
/* harmony import */ var _modules_forms_button_styling__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../modules/forms/button-styling */ "./assets/js/admin/modules/forms/button-styling.js");
/* harmony import */ var _modules_pages_dashboard__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../modules/pages/dashboard */ "./assets/js/admin/modules/pages/dashboard.js");
/* harmony import */ var _modules_pages_support__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../modules/pages/support */ "./assets/js/admin/modules/pages/support.js");
/**
 ...
 * - ../modules/partials/debug
 * - ../modules/partials/modal-shell
 * - ../modules/partials/tabs
 * - ../modules/partials/accordion
 * - ../modules/partials/toast
 * - ../modules/partials/notifications
 * - ../modules/partials/components
 * - ../modules/partials/visitor-tracking
 * - ../modules/partials/url-params
 * - ../modules/partials/admin-bar-responsive
 * - ../modules/modals/modals
 * - ../modules/modals/global-modal
 * - ../modules/modals/preview-modal
 * - ../modules/forms/action-type-fields
 * - ../modules/modals/docs-modal
 * - ../modules/modals/pro-upsell-modal
 * - ../modules/modals/features-modal
 * - ../modules/modals/onboarding-modal
 * - ../modules/modals/format-modal
 * - ../modules/forms/button-styling
 * - ../modules/pages/dashboard
 * - ../modules/pages/support
 *
 * Output: /assets/minimized/js/admin/admin.js
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
