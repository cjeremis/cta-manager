...
!function() {
/*!*************************************************!*\
  !*** ./assets/js/admin/components/dashboard.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _shared_page_bootstrap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../shared/page-bootstrap */ "./assets/js/shared/page-bootstrap.js");
/**
 * CTA Manager - Dashboard Page Entry Point
 *
 * This is the entry point for the main Dashboard page (`cta-manager`).
 * It initializes dashboard page behavior on top of shared admin modules.
 *
 ...
 * - CTAOnboarding
 *
 * Output: /assets/minimized/js/admin/dashboard.js
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(0,_shared_page_bootstrap__WEBPACK_IMPORTED_MODULE_0__.bootstrapPageController)({
  globalName: 'CTADashboardPage',
  define: function (controller) {
    /**
     * Initialize quick action buttons
     */
    controller.initQuickActions = function () {
      // Quick actions are handled by global admin bindings
    };

    /**
     * Initialize overview cards
     */
    controller.initOverviewCards = function () {
      // Overview cards are rendered by PHP
    };
  },
  onReady: function (controller) {
    controller.initQuickActions();
    controller.initOverviewCards();
  },
  readyEvent: 'ctaDashboardReady'
});
}();
/******/ })()
;