/*!
 * CTA Manager - Support Bundle
 *
 * JavaScript bundle for the Support admin page.
 *
 * @package    CTA_Manager
 * @version    1.0.0
 ...
 *
 * This is the entry point for the Support admin page (`cta-manager-support`).
 * It initializes ticket submission and support page interactions.
 *
 ...
 * - CTAToast
 *
 * Output: /assets/minimized/js/admin/support.js
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(0,_shared_page_bootstrap__WEBPACK_IMPORTED_MODULE_1__.bootstrapPageController)({
  globalName: 'CTASupportPage',
  define: function (controller) {
    controller.modules = {
      support: 'CTASupport'
    };
  },
  readyEvent: 'ctaSupportReady'
});
}();
/******/ })()
;