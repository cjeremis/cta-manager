...
(function ($) {
  ...
  EI.bindResetDataModal = function () {
    ...
    $exportBtn.on('click', function () {
      ...
      if (window.ctaModalAPI && typeof window.ctaModalAPI.open === 'function') {
        window.ctaModalAPI.open('#cta-export-options-modal');
      } else {
        $('#cta-export-options-modal').show();
      }
    });
