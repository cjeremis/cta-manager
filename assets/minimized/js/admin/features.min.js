/*!
 * CTA Manager - Features Bundle
 *
 * JavaScript bundle for the Features admin page.
 *
 * @package    CTA_Manager
 * @version    1.0.0
...
!function() {
/*!************************************************!*\
  !*** ./assets/js/admin/components/features.js ***!
  \************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_partials_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../modules/partials/accordion */ "./assets/js/admin/modules/partials/accordion.js");
...
/**
 * CTA Manager - Features Page Entry Point
 *
 * This is the entry point for the Features/Upgrade admin pages
 * (`cta-manager-features`, `cta-manager-upgrade`).
 * It initializes feature page behavior and upgrade-related interactions.
 *
 ...
 * - ctaModalAPI
 *
 * Output: /assets/minimized/js/admin/features.js
 *
 * @package CTA_Manager
 * @since 1.0.0
 */
...
(0,_shared_page_bootstrap__WEBPACK_IMPORTED_MODULE_1__.bootstrapPageController)({
  globalName: 'CTAFeaturesPage',
  define: function (controller) {
    controller.modules = {
      features: 'CTAFeatures'
    };
  },
  readyEvent: 'ctaFeaturesReady'
});
}();
/******/ })()
;